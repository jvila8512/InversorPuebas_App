...
- C:\Users\Javier\.gemini\skills
- C:\Users\Javier\.gemini\antigravity\skills
- C:\Users\Javier\.cursor\skills
- C:\Users\Javier\.copilot\skills
- C:\Users\Javier\.qwen\skills
...
| --- | --- | --- | --- |
| `branch-pr` | Create Gentle AI pull requests with issue-first checks. Trigger: creating, opening, or preparing PRs for review. | user | `C:\Users\Javier\.config\opencode\skills\branch-pr\SKILL.md` |
...
| `find-skills` | — | user | `C:\Users\Javier\.agents\skills\find-skills\SKILL.md` |
...
| `skill-creator` | Trigger: new skills, agent instructions, documenting AI usage patterns. Create LLM-first skills with valid frontmatter. | user | `C:\Users\Javier\.config\opencode\skills\skill-creator\SKILL.md` |
| `skill-improver` | Trigger: improve skills, audit skills, refactor skills, skill quality. Audit and upgrade existing LLM-first skills. | user | `C:\Users\Javier\.config\opencode\skills\skill-improver\SKILL.md` |
